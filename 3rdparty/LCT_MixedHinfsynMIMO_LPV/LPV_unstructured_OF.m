        ...
        switch sys.Ts
            case {0,[]}
                ...
                Term = [T11, T21';
                        T21, T22];   
            otherwise
                error('discrete-time stabilizing controller design not yet implemented');
        end         
        ...
        switch sys.Ts
            case {0,[]}
                ...
                Term = [T11, T21', T31', T41' ;
                        ...
                        T41, T42 , T43 , T44 ];
            otherwise
                error('discrete-time H-infinity controller design not yet implemented');
        end            
    case 2 % H2 controller design
        switch sys.Ts
            case {0,[]}                       
                ...
                Dc_hat = zeros(nu,ny);
            otherwise
                error('discrete-time H2 controller design not yet implemented'); return;
        end
end
