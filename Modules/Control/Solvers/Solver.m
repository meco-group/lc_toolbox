...
classdef Solver
    ...
    properties (Access = private,Constant)
        solverlist = {'Hinfsyn','mixedHinfsyn','sshinfcd','hinfcd','mixedHinfsynMIMO','mixedHinfsynMIMO_unstab','mixedFixedOrder','systune','HIFOO','SynLPV','mixSynLPV','gssshinfcd','mixedpoleMIMO'};
    end
