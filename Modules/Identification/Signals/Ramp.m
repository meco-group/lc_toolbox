...
classdef Ramp < MonomialSignal
    %RAMP A 1-dimensional step signal
    %   Detailed explanation goes here
    
    methods
        function self = Ramp(varargin)
            ...
            self = self@MonomialSignal('degree',1,'label',label,'twindow',twindow,'t0',t0,'fs',fs);
                        
        end
        
        function disp(self)
            disp(['Ramp signal ''' self.label ''' with these properties:']);
