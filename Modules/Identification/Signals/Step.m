...
classdef Step < MonomialSignal
    %STEP A 1-dimensional step signal
    %   Detailed explanation goes here
    
    methods
        function self = Step(varargin)
            ...
            self = self@MonomialSignal('degree',0,'label',label,'twindow',twindow,'t0',t0,'fs',fs);
            
        end
        
        function disp(self)
            disp(['Step signal ''' self.label ''' with these properties:']);
